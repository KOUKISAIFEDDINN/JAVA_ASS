...
<div class="container">
	...
	<div class="row">
	<div class="col"></div>
	<form:form class="col-6 text-end p-5 m-5"  action="/burger/update/${burger.id }" method="post" modelAttribute="burger">
	<input type="hidden" name="_method" value="put">
	    ...
	    <input class="btn btn-lg btn-danger m-3" type="submit" value="Submit"/>
	</form:form>   
